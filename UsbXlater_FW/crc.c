...
#define CRC32_TEST_RESULT 0x0B5D0A7D
#define CRC32_TEST_SIZE 75
static const uint8_t crc32_test_data[CRC32_TEST_SIZE + 1] = {
...
void crc_init()
{
	...
	res = crc32_slow(crc32_test_data, CRC32_TEST_SIZE);
	dbg_printf(DBGMODE_DEBUG, "CRC32 test crc32_slow, result = 0x%08X, ", res);
	if (res == CRC32_TEST_RESULT) {
		dbg_printf(DBGMODE_DEBUG, "PASSED\r\n");
		// the slow function is tested offline and guaranteed to pass
	}
	else {
