...
#define MASK_HOST_INT_CHH(hc_num) { USB_OTG_HCINTMSK_TypeDef  INTMSK; \
    INTMSK.d32 = USB_OTG_READ_REG32(&pcore->regs.HC_REGS[hc_num]->HCINTMSK); \
    INTMSK.b.chhltd = 0; \
    USB_OTG_WRITE_REG32(&pcore->regs.HC_REGS[hc_num]->HCINTMSK, INTMSK.d32);}
...
#define MASK_HOST_INT_ACK(hc_num) { USB_OTG_HCINTMSK_TypeDef  INTMSK; \
    INTMSK.d32 = USB_OTG_READ_REG32(&pcore->regs.HC_REGS[hc_num]->HCINTMSK); \
    INTMSK.b.ack = 0; \
    USB_OTG_WRITE_REG32(&pcore->regs.HC_REGS[hc_num]->HCINTMSK, GINTMSK.d32);}
...
/** @defgroup USB_HCD_INT_Exported_FunctionsPrototype
  ...
  */ 
/* Callbacks handler */
void ConnectCallback_Handler(USB_OTG_CORE_HANDLE *pcore);
void Disconnect_Callback_Handler(USB_OTG_CORE_HANDLE *pcore);
void Overcurrent_Callback_Handler(USB_OTG_CORE_HANDLE *pcore);
