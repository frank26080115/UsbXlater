...
uint32_t    DCD_EP_Close  (USB_OTG_CORE_HANDLE *pcore,
                                uint8_t  ep_addr);
...
uint32_t    DCD_EP_Tx (USB_OTG_CORE_HANDLE *pcore,
                               ...
                               uint8_t  *pbuf,
                               uint32_t   buf_len);
uint32_t    DCD_EP_Stall (USB_OTG_CORE_HANDLE *pcore,
                              uint8_t   epnum);
uint32_t    DCD_EP_ClrStall (USB_OTG_CORE_HANDLE *pcore,
                                  uint8_t epnum);
uint32_t    DCD_EP_Flush (USB_OTG_CORE_HANDLE *pcore,
                               uint8_t epnum);
uint32_t    DCD_Handle_ISR(USB_OTG_CORE_HANDLE *pcore);

uint32_t DCD_GetEPStatus(USB_OTG_CORE_HANDLE *pcore ,
                         uint8_t epnum);

void DCD_SetEPStatus (USB_OTG_CORE_HANDLE *pcore , 
                      uint8_t epnum , 
                      uint32_t Status);
